...
%%%%%%%%HF1%%%%%%%%%%%
imgHF1stschpnt=ceil(imstart+(HF1_index(1)-f_index(1))*(imend-imstart)/index_dif); %HF1的起始点
...
disp(HF1leftpnt);
%%%%%%%%HF2%%%%%%%%%%%
imgHF2stschpnt=ceil(imstart+(HF2_index(1)-f_index(1))*(imend-imstart)/index_dif); %HF2的起始点
